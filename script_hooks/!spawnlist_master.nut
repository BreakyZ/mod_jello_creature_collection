::Const.World.Spawn.Troops.JccBasiliskDrone <- {
...
::Const.World.Spawn.Troops.JccBasiliskSentry <- {
	ID = this.Const.EntityType.JccBasiliskSentry,
	Variant = 0,
	Strength = 20,
	Cost = 35,
	Row = 2,
...
::Const.World.Spawn.Troops.JccCytoplasm <- {
	...
	Cost = 40,
	Row = 2,
	Script = "scripts/entity/tactical/enemies/jcc_cytoplasm"
};
::Const.World.Spawn.Troops.JccCytoplasmMEDIUM <- {
	ID = this.Const.EntityType.JccCytoplasm,
	Variant = 0,
	Strength = 35,
	Cost = 35,
	Row = -1,
	Script = "scripts/entity/tactical/enemies/jcc_cytoplasm_medium"
};
::Const.World.Spawn.Troops.JccCytoplasmHIGH <- {
	ID = this.Const.EntityType.JccCytoplasm,
	Variant = 0,
	Strength = 70,
	Cost = 70,
...
::Const.World.Spawn.Troops.JccCytoplasmOoze <- {
	ID = this.Const.EntityType.JccCytoplasmOoze,
	Variant = 0,
	Strength = 35,
	Cost = 35,
	Row = -1,
...
::Const.World.Spawn.Troops.JccCytoplasmSoldier <- {
	...
	Cost = 35,
	Row = -1,
	Script = "scripts/entity/tactical/enemies/jcc_cytoplasm_soldier"
};
::Const.World.Spawn.Troops.JccCytoplasmBlack <- {
	ID = this.Const.EntityType.JccCytoplasmBlack,
	Variant = 0,
	Strength = 60,
	Cost = 60,
	Row = 2,
...
::Const.World.Spawn.Troops.JccDjinnLOW <- {
	ID = this.Const.EntityType.JccDjinn,
	Variant = 1,
	Strength = 35,
	Cost = 35,
