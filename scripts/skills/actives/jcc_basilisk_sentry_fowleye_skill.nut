this.jcc_basilisk_sentry_fowleye_skill <- this.inherit("scripts/skills/skill", {
	m = {},
...
// - Fowleye: AoE stun based on resolve, has targeting like a warscythe
	...
	function onUse( _user, _targetTile )
	{
		...
		this.Tactical.EventLog.log(this.Const.UI.getColorizedEntityName(_user) + " unleashes a baleful gaze");
