this.hail_skill_percht <- this.inherit("scripts/skills/skill", {
	m = {},
	function create()
	{
		this.m.ID = "actives.hail";
		this.m.Name = "Hail";
		this.m.Description = "Aim for an opponent\'s head. Each striking head can hit or miss on its own for half of the weapon\'s damage, and will strike over or around shield cover.";
	...
	function getTooltip()
	{
		...
		ret.extend([
			...
			},
			{
				...
				type = "text",
				icon = "ui/icons/special.png",
				text = "Will make two separate strikes for half of the weapon\'s damage each."
			}
		]);
