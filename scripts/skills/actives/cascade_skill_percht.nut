this.cascade_skill_percht <- this.inherit("scripts/skills/skill", {
	m = {},
	function create()
	{
		this.m.ID = "actives.cascade";
		this.m.Name = "Cascade";
		this.m.Description = "Let loose a cascade of two striking heads on your opponent. Will strike over or around shield cover.";
