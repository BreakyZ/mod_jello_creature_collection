this.jcc_dragon_guest <- this.inherit("scripts/entity/tactical/player", {
	m = {body_variant=null,
		Size = 1.0,},
	...
	function create()
	{
		this.m.Type = this.Const.EntityType.JccDragonGuest;
	...
	function onDeath( _killer, _skill, _tile, _fatalityType )
	{
		...
		if (_tile != null)
		{
			...
			{
				decal = _tile.spawnDetail("basilisk_sentry_01_dead_arrows", this.Const.Tactical.DetailFlag.Corpse, flip);
				decal.Scale = 0.9;
			}
			else if (_skill && _skill.getProjectileType() == this.Const.ProjectileType.Javelin)
			{
				decal = _tile.spawnDetail("basilisk_sentry_01_dead_javelin", this.Const.Tactical.DetailFlag.Corpse, flip);
				decal.Scale = 0.9;
			}
