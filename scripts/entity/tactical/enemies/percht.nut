this.percht <- this.inherit("scripts/entity/tactical/actor", {
	m = {},
	function create()
	{
		this.m.Type = this.Const.EntityType.Percht;
		this.m.BloodType = this.Const.BloodType.Red;
		this.m.XP = this.Const.Tactical.Actor.Percht.XP;
	...
	function onInit()
	{
		...
		b.setValues(this.Const.Tactical.Actor.Percht);
