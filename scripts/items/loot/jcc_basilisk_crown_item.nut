this.jcc_basilisk_crown_item <- this.inherit("scripts/items/item", {
	m = {},
	function create()
	{
		this.item.create();
		this.m.ID = "misc.jcc_basilisk_crown";
		this.m.Name = "Basilisk Crown";
		this.m.Description = "The magnificient crown of a Queen Basilisk is a much sought-after symbol of legitimacy among trueborn sons and bastards alike.";
		this.m.Icon = "loot/basilisk_crown.png";
