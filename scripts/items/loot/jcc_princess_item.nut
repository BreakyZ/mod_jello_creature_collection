this.jcc_princess_item <- this.inherit("scripts/items/item", {
	m = {},
	function create()
	{
		this.item.create();
		this.m.ID = "misc.jcc_princess";
		this.m.Name = "Noble Remains";
		this.m.Description = "The remains of some important personage, \"rescued\" from the bowels of a dragon.";
		this.m.Icon = "loot/jcc_princess_item.png";
