this.send_djinn_roamers_action <- this.inherit("scripts/factions/faction_action", {
	m = {},
	function create()
	{
		this.m.ID = "send_djinn_roamers_action";
	...
	function onExecute( _faction )
	{
		...
		party.setDescription("Spirits searching the sands for lost and weary travellers.");
