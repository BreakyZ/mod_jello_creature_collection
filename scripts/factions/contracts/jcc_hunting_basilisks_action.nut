this.jcc_hunting_basilisks_action <- this.inherit("scripts/factions/faction_action", {
	m = {},
	function create()
	{
		this.m.ID = "jcc_hunting_basilisks_action";
	...
	function onUpdate( _faction )
	{
		...
		if (!_faction.isReadyForContract(this.Const.Contracts.ContractCategoryMap.jcc_hunting_basilisks_contract))
		{
			return;
		}
	...
	{
		local contract = this.new("scripts/contracts/contracts/jcc_hunting_basilisks_contract");
