this.ai_attack_slime_smack <- this.inherit("scripts/ai/tactical/behavior", {
	m = {
		PossibleSkills = [
			"actives.slime_smack"
		],
	...
	function create()
	{
		this.m.ID = this.Const.AI.Behavior.ID.SlimeSmack;
		this.m.Order = this.Const.AI.Behavior.Order.SlimeSmack;
