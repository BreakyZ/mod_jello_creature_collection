this.perchta_ranged_agent <- this.inherit("scripts/ai/tactical/agent", {
	m = {},
	function create()
	{
		this.agent.create();
		this.m.ID = this.Const.AI.Agent.ID.PerchtaRanged;
		this.m.Properties.BehaviorMult[this.Const.AI.Behavior.ID.BoostMorale] = 5.0;
