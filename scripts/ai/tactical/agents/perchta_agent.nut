this.perchta_agent <- this.inherit("scripts/ai/tactical/agent", {
	m = {},
	function create()
	{
		this.agent.create();
		this.m.ID = this.Const.AI.Agent.ID.Perchta;
		...
		//this.m.Properties.BehaviorMult[this.Const.AI.Behavior.ID.Charge] = 10.0;
	...
	function onAddBehaviors()
	{
		...
		this.addBehavior(this.new("scripts/ai/tactical/behaviors/ai_krampus_charge"));
